...
public class BespokeRunner {
	public static void main(String [] args) {
		System.out.println(Runtime.getRuntime().maxMemory());
		
		int maxPeriod = 26;
		int maxIterations = 50000;
		Period pe = makeRupScenario(0.0, 0.00, new SimpleProbability(0.8), new LinearProbabilityStrategy(0.02));
		//Period pe = makeRupScenario(0, 0, new SimpleProbability(0.8), new LinearProbabilityStrategy(0.02));
		//Period pe = makeRupScenario(.75, .75, new SimpleProbability(0.8), new LinearProbabilityStrategy(0.02));
